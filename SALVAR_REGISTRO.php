<?php include 'header.php';
	...
	$registro = mysqli_affected_rows($connection);
		...
		echo "<h2> <font color = #1AC8ED> <b> <img src = 'logo/logo2.png'> </b>  <br> <br>";

		if ($RESULTADO <= 20) {
			echo "Nenhum indício da Burnout. <BR> <BR>
			<img src='logo/feliz.png'>";
			...
			<img src='logo/maisoumenos.png' <BR> ";
